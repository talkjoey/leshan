...
public class BootstrapTest {
    ...
    public void start() throws ConfigurationException {
        ...
        BootstrapStoreImpl bsStore = (BootstrapStoreImpl) helper.bootstrapServer.getBoostrapStore();
        bsStore.addConfig(IntegrationTestHelper.ENDPOINT_IDENTIFIER,
                helper.getBsConfig(helper.bootstrapServer.getNonSecureAddress()));
